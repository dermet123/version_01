...
const submit = () => {
    router.get(route("facultad.index", form.value));
};
...
const deleteFacultad = () => {
    ...
    router.delete(
        route("facultad.destroy", { facultad: selectedFacultad.value.id })
    );
    ...
    <AppLayout title="Dashboard">
                ...
                >
                    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                        ...
                        <table class="table-auto w-full">
                            ...
                            <tbody>
                                <tr v-for="f in facultades.data" :key="f.id">
                                    ...
                                    <td>
                                        <ul>
                                            <li v-if="f.escuelas.length">
                                                <template
                                                    v-for="escuela in f.escuelas"
                                                    :key="escuela.id"
                                                >
                                                    {{ escuela.nombre
                                                    }}<span v-if="!$last"
                        ...
                        <paginator class="mt-3" :paginator="facultades" />
                    </div>
                </div>
            </div>
        </div>
        <dialog-modal :show="modalOpen">
            ...
            <template v-slot:content>
                <p v-if="selectedFacultad">
                    ¿Seguro que quieres elimnar la Facultad:
                    <strong>{{ selectedFacultad.nombre }}?</strong>
                </p>
            </template>
            <template #footer>
                <PrimaryButton
