...
const submit = () => {
    router.get(route("modulo.index", form.value));
};
...
const deleteModulo = () => {
    ...
    router.delete(route("modulo.destroy", { modulo: selectedModulo.value.id }));
    ...
    <AppLayout title="Dashboard">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                        ...
                        <table class="table-auto w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th class="p-3">Estandar Dinamico</th> -->
                                    <th class="p-3">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="modu in modulos.data" :key="modu.id">
                                    <td class="p-3 border">{{ modu.id }}</td>
                        ...
                        <paginator class="mt-3" :paginator="modulos" />
                    </div>
                </div>
            </div>
        </div>
        <dialog-modal :show="modalOpen">
            ...
            <template v-slot:content>
                <p v-if="selectedModulo">
                    ¿Seguro que quieres eliminar el Modulo:
                    <strong>{{ selectedModulo.nombre }}?</strong>
                </p>
            </template>
            <template #footer>
                <PrimaryButton
