...
const submit = () => {
    router.get(route("modelo.index", form.value));
};
...
const deleteModelo = () => {
    ...
    router.delete(route("modelo.destroy", { modelo: selectedModelo.value.id }));
    ...
    <AppLayout title="Dashboard">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                        ...
                        <table class="table-auto w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th class="p-3">Fecha de Creacion</th>
                                    <th class="p-3">Cantidad de Estandares</th>
                                    <th class="p-3">Fecha de Vigencia</th>
                                    <th class="p-3">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="mode in modelos.data" :key="mode.id">
                                    <td class="p-3 border">{{ mode.id }}</td>
                        ...
                        <paginator class="mt-3" :paginator="modelos" />
                    </div>
                </div>
            </div>
        </div>
        <dialog-modal :show="modalOpen">
            ...
            <template v-slot:content>
                <p v-if="selectedModelo">
                    ¿Seguro que quieres elimnar el Modelo:
                    <strong>{{ selectedModelo.nombre }}?</strong>
                </p>
            </template>
            <template #footer>
                <PrimaryButton
